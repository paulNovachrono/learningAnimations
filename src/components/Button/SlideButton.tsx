...
function Box () {
    return <div className="absolute group-hover:left-[calc(100%-2rem)] group-hover:transform group-hover:rotate-180 ease-out left-0 inset-y-0 my-auto transition-all duration-700 size-8 bg-primary rounded-md flex flex-col justify-center items-center mx-w-[90%] gap-[2px] z-40">
